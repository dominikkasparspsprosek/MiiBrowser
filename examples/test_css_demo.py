...
def main():
    ...
    print("  [OK] Color and background color support")
    print("  [OK] Width and height utilities")
    print("  [OK] Position (relative, absolute, fixed)")
    print("  [OK] Z-index layering")
    print("  [OK] Spacing utilities (margin, padding)")
    print("  [OK] Text alignment")
    print("  [OK] Borders and rounded corners")
    print("  [OK] Opacity")
    print("  [OK] Responsive images")
    print("  [OK] Styled tables")
    print("\n" + "=" * 60)
